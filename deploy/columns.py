...
def get_room_type_column_name(key):
    if key in room_type_columns:
        return room_type_columns[key]
    return False
...
def get_property_type_column_name(key):
    if key in property_type_columns:
        return property_type_columns[key]
    return False

cancellation_policy_columns = {
...
def get_cancellation_policy_column_name(key):
    if key in cancellation_policy_columns:
        return cancellation_policy_columns[key]
    return False
